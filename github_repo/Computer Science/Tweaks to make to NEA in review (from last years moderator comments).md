	NB: Trend for Mr. Bowens marking is to be ~2 marks above the actual.

### Design
- Make sure to have the right amount of detail for your algorithms


#### Development
- Check to see if, for JSON, you've described how specifically IN YOUR NEA you are retrieving and changing values.
